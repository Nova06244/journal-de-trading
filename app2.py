...
xaxis=dict(gridcolor=”#1e3040”, tickfont=dict(color=”#c0d8f0”, size=13), linecolor=”#1e3040”),
yaxis=dict(gridcolor=”#1e3040”, tickfont=dict(color=”#c0d8f0”, size=13), linecolor=”#1e3040”),
showlegend=False,
height=height,
...
if df.empty:
    ...
    with col1:
        fig_wl = go.Figure(go.Pie(
            ...
            hole=0.55,
            marker=dict(colors=["#00e5a0","#ff4060","#a060ff"], line=dict(color="#0d1520", width=3)),
