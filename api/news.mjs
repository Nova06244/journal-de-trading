export default async function handler(req, res) {
  ...
  const prompt = "Tu es expert calendrier economique forex EUR/USD. Aujourd'hui " + today + " (" + dayName + "). Fenetres de trading heure Paris : F1=08h30-12h00 Londres, F2=13h30-15h30 New York. Analyse les news du jour impactant EUR/USD. Statut: ROUGE=NE PAS TRADER, ORANGE=PRUDENCE, VERT=TRADER. Reponds UNIQUEMENT en JSON strict sans markdown: {\"date\":\"" + today + "\",\"resume_macro\":\"texte\",\"fenetre1\":{\"statut\":\"VERT\",\"verdict\":\"TRADER\",\"horaire\":\"08h30 - 12h00\",\"news\":[],\"conseil\":\"conseil\"},\"fenetre2\":{\"statut\":\"VERT\",\"verdict\":\"TRADER\",\"horaire\":\"13h30 - 15h30\",\"news\":[],\"conseil\":\"conseil\"},\"alertes_hors_fenetres\":[],\"bce_fed\":{\"prochaine_bce\":\"date\",\"prochaine_fed\":\"date\",\"info\":\"info\"}}";
