    ...
    <div>
      ...
      {res&&(
        <div>
          ...
          {res.all.filter(function(s){return s.ok;}).map(function(s){return <SCard key={s.niv} sc={s} cur={false} mode={props.mode} lot={props.lot}/>;} )}
