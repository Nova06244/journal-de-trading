  ...
  return(
    <div>
      ...
      {!props.activePair||!props.newsStatut?null:props.newsStatut==="ROUGE"?(
        ...
        <button onClick={props.onAnalyse} style={{width:"100%",padding:13,background:"#3b82f6",border:"none",borderRadius:10,color:"#fff",fontSize:12,letterSpacing:2,fontWeight:600,cursor:"pointer",fontFamily:"'DM Mono',monospace",marginBottom:16}}>
          → ANALYSER LE SETUP
        </button>
      )}
