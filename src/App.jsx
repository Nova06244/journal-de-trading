...
function doAnalyse(price,pp,r1,r2,s1,s2,heure,mode,ctx){
  ...
  if(mode==="limite"){
    ...
    var contraH4=biaisH4&&ms.dir!==biaisH4;
    sig=contraH4?"NO TRADE":ms.ok?ms.dir:"NO TRADE";
    conf=contraH4?"FAIBLE":!ms.ok?"FAIBLE":(fen?"FORTE":"MOYENNE");
    if(contraH4){
      anl="Setup "+ms.dir+" sur "+cn+" mais CONTRA le biais H4 ("+biaisH4+"). Trade invalide.";
      csl="Ignorer ce setup. Attendre un niveau dans le sens H4 "+biaisH4+".";
    } else {
    ...
    <div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 2fr",gap:10,marginBottom:12}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:8}}>
          ...
          <div style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.06)",borderRadius:10,padding:10}}>
            <div style={{fontSize:9,color:"#475569",marginBottom:6,letterSpacing:1}}>PP H4</div>
            <input type="number" step="0.00001" placeholder="1.XXXXX" value={props.ppH4} onChange={function(e){props.setPpH4(e.target.value);}} style={{width:"100%",background:"rgba(255,255,255,0.04)",border:"1px solid rgba(234,179,8,0.3)",borderRadius:7,padding:"7px 8px",color:"#eab308",fontSize:12,fontFamily:"'DM Mono',monospace",outline:"none"}}/>
          </div>
        </div>
      </div>
        ...
        <div>
          <div style={{background:sigB,border:"1px solid "+sigC+"44",borderRadius:12,padding:16,marginBottom:14}}>
            ...
            <div style={{display:"flex",gap:8,marginBottom:12,flexWrap:"wrap"}}>
              ...
              {res.biaisH4&&<span style={{background:res.biaisH4==="LONG"?"rgba(34,197,94,0.1)":"rgba(239,68,68,0.1)",border:"1px solid "+(res.biaisH4==="LONG"?"rgba(34,197,94,0.3)":"rgba(239,68,68,0.3)"),borderRadius:6,padding:"5px 10px",fontSize:10,color:res.biaisH4==="LONG"?"#22c55e":"#ef4444",fontWeight:600}}>H4 {res.biaisH4==="LONG"?"▲":"▼"} {res.biaisH4}</span>}
...
export default function PivotAgent(){
  ...
  function onAnalyse(){
    ...
    var ctxFull=(biaisH4sel?("H4 "+biaisH4sel):"")+(ppH4?" PP H4 "+ppH4:"")+(ctx?" "+ctx:"");
