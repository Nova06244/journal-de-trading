      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 2fr",gap:10,marginBottom:12}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:8}}>
          <div style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.06)",borderRadius:10,padding:10}}>
            ...
            <button onClick={function(){props.setIsRetournement(!props.isRetournement);}} disabled={props.biaisM30sel===""} style={{width:"100%",padding:"7px 4px",background:props.isRetournement?"rgba(168,85,247,0.2)":"rgba(255,255,255,0.03)",border:"1px solid "+(props.isRetournement?"rgba(168,85,247,0.5)":"rgba(255,255,255,0.1)"),borderRadius:7,color:props.isRetournement?"#c084fc":props.biaisM30sel===""?"#2d3748":"#475569",fontSize:10,cursor:props.biaisM30sel===""?"not-allowed":"pointer",fontWeight:props.isRetournement?700:400,fontFamily:"'DM Mono',monospace",opacity:props.biaisM30sel===""?0.4:1}}>
              ↩ RETOURNEMENT {props.isRetournement&&props.biaisM30sel?(props.biaisM30sel==="LONG"?"→ SELL STOP sur R1/R2":"→ BUY STOP sur S1/S2"):""}
            </button>
          </div>
          <div style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.06)",borderRadius:10,padding:10}}>
