...
function TabNews(props){
  ...
  var st1=props.checks[0]?"ROUGE":props.checks[1]?"ORANGE":"VERT";
  var st2=props.checks[2]?"ROUGE":props.checks[3]?"ORANGE":"VERT";
    ...
    <div>
      ...
      <div style={{background:stBg(st1),border:"1px solid "+stBorder(st1),borderRadius:12,padding:16,marginBottom:14}}>
        ...
        <div style={{display:"flex",gap:8,marginBottom:12}}>
          <button onClick={function(){props.tc(0);}} style={{flex:1,padding:"6px",background:props.checks[0]?"rgba(239,68,68,0.2)":"rgba(255,255,255,0.04)",border:"1px solid "+(props.checks[4]?"rgba(239,68,68,0.4)":"rgba(255,255,255,0.1)"),borderRadius:6,color:props.checks[0]?"#ef4444":"#64748b",fontSize:10,cursor:"pointer",fontFamily:"'DM Mono',monospace"}}>🔴 NEWS ROUGE</button>
          <button onClick={function(){props.tc(1);}} style={{flex:1,padding:"6px",background:props.checks[1]?"rgba(234,179,8,0.2)":"rgba(255,255,255,0.04)",border:"1px solid "+(props.checks[5]?"rgba(234,179,8,0.4)":"rgba(255,255,255,0.1)"),borderRadius:6,color:props.checks[1]?"#eab308":"#64748b",fontSize:10,cursor:"pointer",fontFamily:"'DM Mono',monospace"}}>🟡 NEWS ORANGE</button>
          <button onClick={function(){if(props.checks[0])props.tc(0);if(props.checks[1])props.tc(1);}} style={{flex:1,padding:"6px",background:st1==="VERT"?"rgba(34,197,94,0.2)":"rgba(255,255,255,0.04)",border:"1px solid "+(st1==="VERT"?"rgba(34,197,94,0.4)":"rgba(255,255,255,0.1)"),borderRadius:6,color:st1==="VERT"?"#22c55e":"#64748b",fontSize:10,cursor:"pointer",fontFamily:"'DM Mono',monospace"}}>🟢 LIBRE</button>
        </div>
      ...
      <div style={{background:stBg(st2),border:"1px solid "+stBorder(st2),borderRadius:12,padding:16,marginBottom:14}}>
        ...
        <div style={{display:"flex",gap:8,marginBottom:12}}>
          <button onClick={function(){props.tc(2);}} style={{flex:1,padding:"6px",background:props.checks[2]?"rgba(239,68,68,0.2)":"rgba(255,255,255,0.04)",border:"1px solid "+(props.checks[6]?"rgba(239,68,68,0.4)":"rgba(255,255,255,0.1)"),borderRadius:6,color:props.checks[2]?"#ef4444":"#64748b",fontSize:10,cursor:"pointer",fontFamily:"'DM Mono',monospace"}}>🔴 NEWS ROUGE</button>
          <button onClick={function(){props.tc(3);}} style={{flex:1,padding:"6px",background:props.checks[3]?"rgba(234,179,8,0.2)":"rgba(255,255,255,0.04)",border:"1px solid "+(props.checks[7]?"rgba(234,179,8,0.4)":"rgba(255,255,255,0.1)"),borderRadius:6,color:props.checks[3]?"#eab308":"#64748b",fontSize:10,cursor:"pointer",fontFamily:"'DM Mono',monospace"}}>🟡 NEWS ORANGE</button>
          <button onClick={function(){if(props.checks[2])props.tc(2);if(props.checks[3])props.tc(3);}} style={{flex:1,padding:"6px",background:st2==="VERT"?"rgba(34,197,94,0.2)":"rgba(255,255,255,0.04)",border:"1px solid "+(st2==="VERT"?"rgba(34,197,94,0.4)":"rgba(255,255,255,0.1)"),borderRadius:6,color:st2==="VERT"?"#22c55e":"#64748b",fontSize:10,cursor:"pointer",fontFamily:"'DM Mono',monospace"}}>🟢 LIBRE</button>
        </div>
        <p style={{fontSize:10,color:"#475569",letterSpacing:1,marginBottom:8,marginTop:0}}>NEWS HABITUELLES SUR CETTE FENÊTRE</p>
        {f2.map(function(n,i){
          return(
