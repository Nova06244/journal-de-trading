...
export default function PivotAgent(){
  ...
  function compressImg(dataUrl,maxW,quality){
  ...
  async function onAnalyse(){
    ...
    if(imgM30||imgM15){
      ...
      try{
        ...
        var compM30=imgM30?await compressImg(imgM30,800,0.6):null;
        var compM15=imgM15?await compressImg(imgM15,800,0.6):null;
        var r=await fetch("https://zqtmjxsjurdrcnwissmn.supabase.co/functions/v1/smooth-task",{
          method:"POST",
          headers:{"Content-Type":"application/json","apikey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpxdG1qeHNqdXJkcmNud2lzc21uIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzE2OTY3NjksImV4cCI6MjA4NzI3Mjc2OX0.hAiO03vpGlfAnqlkVZ34yy-tQ3JqRhWDCG3h05Nq-qM","Authorization":"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpxdG1qeHNqdXJkcmNud2lzc21uIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzE2OTY3NjksImV4cCI6MjA4NzI3Mjc2OX0.hAiO03vpGlfAnqlkVZ34yy-tQ3JqRhWDCG3h05Nq-qM"},
          body:JSON.stringify({mode:"charts",imgM30:compM30||null,imgM15:compM15||null,r2:r2,r1:r1,pp:pp,s1:s1,s2:s2,price:price})
        });
        var d=await r.json();
        var txt=d.analyse||d.error||"Erreur inconnue";
        setErr("📊 "+txt);
