      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 2fr",gap:10,marginBottom:12}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:8}}>
          ...
          <div style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.06)",borderRadius:10,padding:10}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:6}}>
              <button onClick={function(){props.setBiaisM15sel("");}} style={{padding:"7px 4px",background:props.biaisM15sel===""?"rgba(255,255,255,0.1)":"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:7,color:"#64748b",fontSize:10,cursor:"pointer",fontFamily:"'DM Mono',monospace"}}>—</button>
              <button onClick={function(){props.setBiaisM15sel("LONG");}} style={{padding:"7px 4px",background:props.biaisM15sel==="LONG"?"rgba(34,197,94,0.2)":"rgba(255,255,255,0.03)",border:"1px solid "+(props.biaisM15sel==="LONG"?"rgba(34,197,94,0.5)":"rgba(255,255,255,0.1)"),borderRadius:7,color:props.biaisM15sel==="LONG"?"#22c55e":"#475569",fontSize:10,cursor:"pointer",fontWeight:props.biaisM15sel==="LONG"?700:400,fontFamily:"'DM Mono',monospace"}}>▲ HAUSSIER</button>
              <button onClick={function(){props.setBiaisM15sel("SHORT");}} style={{padding:"7px 4px",background:props.biaisM15sel==="SHORT"?"rgba(239,68,68,0.2)":"rgba(255,255,255,0.03)",border:"1px solid "+(props.biaisM15sel==="SHORT"?"rgba(239,68,68,0.5)":"rgba(255,255,255,0.1)"),borderRadius:7,color:props.biaisM15sel==="SHORT"?"#ef4444":"#475569",fontSize:10,cursor:"pointer",fontWeight:props.biaisM15sel==="SHORT"?700:400,fontFamily:"'DM Mono',monospace"}}>▼ BAISSIER</button>
            </div>
          </div>
      ...
      <div style={{marginTop:8,background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:12,padding:14}}>
        ...
        {(props.activePair||props.newsStatut||props.biaisM30sel||props.biaisM15sel||biaisJournee)&&(
          <div style={{background:"rgba(0,0,0,0.2)",borderRadius:8,padding:"8px 10px",marginBottom:10,display:"flex",flexWrap:"wrap",gap:6}}>
            ...
            {props.biaisM15sel&&<span style={{fontSize:9,color:"#94a3b8",background:"rgba(255,255,255,0.05)",borderRadius:4,padding:"2px 6px"}}>{props.biaisM15sel==="LONG"?"▲":"▼"} M15</span>}
...
export default function PivotAgent(){
  ...
  async function onAdd(){
    ...
    try {
      ...
      setJDateSortie(TODAY);setJHeureSortie("");
