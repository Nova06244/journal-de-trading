        ...
        <div>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
            ...
            <button onClick={function(){
              var headers=["date","heure","pair","niveau","timeframe","dir","resultat","gain","commission","lot","sl_pips","tp_pips","rr","news_statut","biais_m30","rsi7","signal_entree","is_retournement","date_sortie","heure_sortie","duree_minutes","note"];
...
export default function PivotAgent(){
  ...
  function startEdit(t){
    ...
    if(t.rsi7)setBiaisM15sel(t.is_retournement?"":t.rsi7);
