...
function TabSignal(props){
  ...
  return(
    <div>
      ...
      {/* Statut NEWS — affiché seulement si paire sélectionnée */}
      {props.activePair?(
        <div style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.06)",borderRadius:10,padding:10,marginBottom:14}}>
          <div style={{fontSize:9,color:"#475569",marginBottom:6,letterSpacing:1}}>STATUT NEWS — {props.activePair==="EURUSD"?"EUR/USD":"GBP/USD"}</div>
