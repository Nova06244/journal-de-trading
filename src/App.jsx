      ...
      <div style={CARD}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:10}}>
          <div>
            ...
            <input type="date" value={props.jDate} onChange={function(e){props.setJDate(e.target.value);}} style={{...INP,fontSize:11,padding:"9px 6px"}}/>
          </div>
          <div>
            <div style={{fontSize:9,color:"#475569",marginBottom:4}}>HEURE</div>
            <input type="time" value={props.jHeure2} onChange={function(e){props.setJHeure2(e.target.value);}} style={{...INP,fontSize:11,padding:"9px 6px"}}/>
          </div>
        </div>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,marginBottom:10}}>
          <div>
